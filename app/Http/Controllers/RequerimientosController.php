...
class RequerimientosController extends Controller
{
    ...
    public function reporte_individual(Request $request){
       ...
       if($request->inicio && $request->fin && $request->solicita){
        ...
        return view('reportes.reporte_individual', compact('requerimientos','f1','f2','alma'));

    }

    public function reporte_individual_pdf($prod, $almacen, $f1, $f2){
          ...
          $view = \View::make('reportes.reporte_individual_pdf', compact('f1','f2','requerimientos','almacen'));
